...
/*
 ...
 LIKE
    ...
    - Undersoce ( _ ) for matching any single character
...
-- display all employees where first_name startswith B and length of it 5 letter
select * from EMPLOYEES
...
-- NOTE ---> Values are CASE SENSITIVE
        --> KEYWORDs/TABLE/COLUMNS are NOT CASE SENSITIVE


-- display 5 letter first name from employees ending with e
select * from EMPLOYEES
